...
export function Footer({ locale }: { locale: string }) {
  ...
  return (
    <footer className='p-4 bg-ecommerce-900 text-ecommerce-100'>
      {/* <div>Newsletter</div> */}
      <div className='grid grid-rows-app-footer-links md:grid-rows-app-footer-links-md grid-cols-app-footer-links md:grid-cols-app-footer-links-md md:space-x-10 space-y-8 md:space-y-0 pb-4 md:py-6 text-center md:text-start'>
      ...
      <div id="copyright" className='flex flex-col-reverse md:grid md:grid-cols-app-footer-copyright pt-4 md:pt-2 border-t border-ecommerce-700 text-ecommerce-500 text-sm text-center md:text-start'>
